...
| F46 | Canvas attachment controls | Select either endpoint side directly on the canvas; retain endpoints, labels and authored routing; keyboard accessible and undoable. | Pending |
