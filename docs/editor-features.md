...
F11–F28 are approved for implementation. **Implemented: F11–F26.** Remaining features are pending. Priority reflects the benefit to manual refinement: P1 removes common editing friction, P2 expands visual authoring, and P3 improves larger-document workflows.
